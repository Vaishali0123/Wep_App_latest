...
//   const [postid, setPostId] = useState<Array<string> | null>([]);
...
//   // Track clicks
//   const trackClick = (postId: string) => {
//     if (!clickData.includes(postId)) {
//       setClickData((prev) => [...prev, postId]);
//       startTimer();
//     }
//   };
...
//                       : ""} */}
//                     {switcher === 0 ? d?.posts?.sender?.fullname : d?.fullname}
//                   </div>
//                 </div>
//               </Link>
//               {switcher === 0 &&
...
//                       )}
//                     {d?.posts?.community?.members?.length &&
//                       d?.posts?.community?.members?.length >= 4 && (
//                         <div className="h-[25px] w-[25px] bg-slate-300 -ml-4 rounded-[10px]">
//                           <img
//                             className="w-[100%] h-[100%] object-cover rounded-[10px]"
//                             src={d?.memdps?.[3]}
...
//                         <div className="h-[25px] w-[25px] bg-slate-400 -ml-4 rounded-[10px]">
//                           <img
//                             className="w-[100%] object-cover h-[100%] rounded-[10px] "
//                             src={d?.memdps?.[2]}
//                             alt="Grovyo user"
//                           />
//                         </div>
...
//                         <div className="h-[25px] w-[25px] bg-slate-300 -ml-4 rounded-[10px]">
//                           <img
//                             className="w-[100%] h-[100%] object-cover rounded-[10px] object-contain"
//                             src={d?.memdps?.[3]}
//                             alt="Grovyo user"
//                           />
//                         </div>
